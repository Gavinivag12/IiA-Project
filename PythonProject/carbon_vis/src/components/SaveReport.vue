<template>
  <div>
    <div
      class="md-layout xxx-md-alignment-center-left md-gutter"
      v-if="!reportSaved"
    >
      ...
      <div class="md-layout-item md-size-30 md-caption">
        Give this report a name you can remeber it by!
      </div>
...
export default {
  ...
  methods: {
    ...
    async saveObjects(objects) {
      const chunks = this.chunk(objects, 25);
      ...
      try {
        for (let ch of chunks) {
          ...
          savedObjectIds.push(...res.data.resources);
        }
        ...
        this.loadingMessage = `Saving failed with statuscode: ${
          this.statusCode
        } - please contact support and provide this code`;
      }
